<template><div><h1 id="springdatajpa" tabindex="-1"><a class="header-anchor" href="#springdatajpa" aria-hidden="true">#</a> SpringDataJPA</h1>
<h2 id="_1-注解" tabindex="-1"><a class="header-anchor" href="#_1-注解" aria-hidden="true">#</a> 1. 注解</h2>
