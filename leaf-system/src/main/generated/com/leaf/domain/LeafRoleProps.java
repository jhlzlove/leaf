...
public interface LeafRoleProps extends BaseEntityProps {
    ...
    TypedProp.Reference<LeafRole, LeafUser> CREATE_BY = 
        TypedProp.reference(ImmutableType.get(LeafRole.class).getProp("createBy"));

    TypedProp.Reference<LeafRole, LeafUser> UPDATE_BY = 
        TypedProp.reference(ImmutableType.get(LeafRole.class).getProp("updateBy"));
