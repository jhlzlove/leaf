...
public class LeafRoleFetcher extends AbstractTypedFetcher<LeafRole, LeafRoleFetcher> {
    ...
    @NewChain
    public LeafRoleFetcher createBy(Fetcher<LeafUser> childFetcher) {
    ...
    @NewChain
    public LeafRoleFetcher createBy(IdOnlyFetchType idOnlyFetchType) {
    ...
    @NewChain
    public LeafRoleFetcher updateBy(Fetcher<LeafUser> childFetcher) {
    ...
    @NewChain
    public LeafRoleFetcher updateBy(IdOnlyFetchType idOnlyFetchType) {
